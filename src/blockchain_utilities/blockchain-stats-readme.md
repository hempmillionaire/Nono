...
See also the utility's help option. `nono-blockchain-stats --help`

From the command line run:

`$ nono-blockchain-stats`
...
- `nono-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `nono-blockchain-stats | save-to-database.sh`
